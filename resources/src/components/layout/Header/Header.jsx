...
import { 
  ShoppingCart, Search, Menu, X, Phone, ArrowRight 
} from 'lucide-react';

// --- MOCK DATA: Đã kiểm tra khớp Slug với Database SQL ---
const MEGA_MENU_DATA = [
  {
    id: 1,
    title: "CÀ PHÊ & ESPRESSO",
    path: "/menu?category=cafe", // Slug: cafe
  ...
  },
  {
    id: 2,
    title: "TRÀ & TRÀ SỮA",
    path: "/menu?category=tra", // Slug: tra
  ...
  },
  {
    ...
    path: "/menu?category=da-xay", // Slug: da-xay
  ...
  },
  {
    ...
    path: "/menu?category=banh-ngot", // Slug: banh-ngot
  ...
  },
  {
    ...
    path: "/menu?category=banh-mi", // Slug: banh-mi
  ...
  },
  {
    ...
    path: "/menu?category=banh-au", // Slug: banh-au
  ...
  },
  {
    ...
    path: "/menu?category=nuoc-ep", // Slug: nuoc-ep
...
const Header = () => {
                ...
                <div 
                  ...
                  onMouseEnter={() => {
                    if (item.isMega) {
                      ...
                      setHoveredCategory(MEGA_MENU_DATA[0]);
                    }
                  }}
  ...
  >
                             ...
                             {MEGA_MENU_DATA.map((category) => (
                               ...
                               >
                                  ...
                                  <div className="absolute bottom-0 left-0 w-full p-16 text-white transform transition-transform duration-500 translate-y-0">
                                    ...
                                    {/* Link bao quanh tiêu đề để click được cả hình */}
                                    <Link to={category.path}>
                                      <h3 className="text-5xl font-black tracking-tight mb-4 leading-tight hover:text-amber-400 transition-colors">
                                      {category.title}
                                    </h3>
                                    </Link>
            ...
            <div className="flex items-center gap-2">
               ...
               {/* Sửa link thành /menu thay vì /order */}
               <Link to="/menu" className="hidden lg:flex ml-4 px-8 py-3 bg-slate-900 text-white text-xs font-bold tracking-widest hover:bg-amber-700 transition-colors">
                 ORDER ONLINE
               </Link>
            </div>
          </div>
